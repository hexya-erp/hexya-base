hexya.define('web.DataExport', function (require) {
"use strict";
...
var DataExport = Dialog.extend({
    ...
    on_show_data: function(result, after) {
        ...
        if (after) {
            ...
            current_tr.find('img').attr('src','/static/web/src/img/collapse.gif');
    ...
    showcontent: function(id) {
        ...
        if (is_open) {
            first_child.attr('src', '/static/web/src/img/expand.gif');
        } else {
            first_child.attr('src', '/static/web/src/img/collapse.gif');
        }
        ...
        for (var i = 0; i < child_field.length; i++) {
            ...
            if (is_open) {
                ...
                if ($child.hasClass('open')) {
                    ...
                    $child.find('img').attr('src', '/static/web/src/img/expand.gif');
                }
                $child.show();
            }
        }

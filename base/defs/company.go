...
func initCompany() {
	...
	company.AddMany2OneField("Parent", models.ForeignKeyFieldParams{RelationModel: "Company", String: "Parent Company", Index: true})
	company.AddOne2ManyField("Children", models.ReverseFieldParams{RelationModel: "Company", ReverseFK: "Parent", String: "Child Companies"})
	company.AddMany2OneField("Partner", models.ForeignKeyFieldParams{RelationModel: "Partner", Required: true, Index: true})
	...
	company.AddMany2OneField("Currency", models.ForeignKeyFieldParams{RelationModel: "Currency", Required: true})
	company.AddMany2ManyField("Users", models.Many2ManyFieldParams{RelationModel: "User", String: "Accepted Users"})
	...
	company.AddMany2OneField("State", models.ForeignKeyFieldParams{RelationModel: "CountryState", Related: "Partner.State"})
	company.AddMany2OneField("Country", models.ForeignKeyFieldParams{RelationModel: "Country", Related: "Partner.Country"})

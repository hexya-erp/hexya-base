...
func init() {
	...
	pool.SequenceDateRange().AddIntegerField("NumberNextActual", models.SimpleFieldParams{
	...
	pool.Sequence().AddSelectionField("Implementation", models.SelectionFieldParams{
...
gap in the sequence (while they are possible in the former).`})
	...
	pool.Sequence().AddIntegerField("NumberNextActual", models.SimpleFieldParams{
	...
	pool.Sequence().AddOne2ManyField("DateRanges", models.ReverseFieldParams{RelationModel: pool.SequenceDateRange(),
		ReverseFK: "Sequence"})
